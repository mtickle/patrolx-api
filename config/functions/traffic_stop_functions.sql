...
CREATE OR REPLACE FUNCTION public.get_traffic_stops_by_type(
	recordlimit integer)
...
END;
$BODY$;
ALTER FUNCTION public.get_traffic_stops_by_agency(integer)
    OWNER TO pi;
...
CREATE OR REPLACE FUNCTION public.get_traffic_stops_by_gender(
	recordlimit integer)
    RETURNS TABLE(itemname character varying, itemcount bigint) 
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION public.get_traffic_stops_by_gender(integer)
    OWNER TO pi;
...
CREATE OR REPLACE FUNCTION public.get_traffic_stops_by_race(
	recordlimit integer)
    RETURNS TABLE(itemname character varying, itemcount bigint) 
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION public.get_traffic_stops_by_race(integer)
    OWNER TO pi;
...
CREATE OR REPLACE FUNCTION public.get_traffic_stops_by_make(
	recordlimit integer)
    RETURNS TABLE(itemname character varying, itemcount bigint) 
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION public.get_traffic_stops_by_make(integer)
    OWNER TO pi;
