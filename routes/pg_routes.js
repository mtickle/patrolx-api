...
router.post("/postRoadCondition", async (req, res) => {
    ...
    try {
        await pool.query(`
      CALL public.insert_incident(
        $1::INTEGER, $2::DOUBLE PRECISION, $3::DOUBLE PRECISION, $4::TEXT,
        $5::TEXT, $6::TEXT, $7::TEXT, $8::INTEGER, $9::TEXT, $10::TEXT,
        $11::INTEGER, $12::TEXT, $13::TEXT, $14::TIMESTAMPTZ, $15::TIMESTAMPTZ,
        $16::TIMESTAMPTZ, $17::TEXT, $18::INTEGER, $19::BOOLEAN, $20::TEXT,
        $21::INTEGER, $22::INTEGER, $23::INTEGER, $24::INTEGER, $25::INTEGER,
        $26::INTEGER, $27::BOOLEAN, $28::BOOLEAN, $29::BOOLEAN, $30::BOOLEAN,
        $31::BOOLEAN, $32::BOOLEAN, $33::TIMESTAMPTZ, $34::TEXT, $35::INTEGER,
        $36::TEXT, $37::TEXT, $38::INTEGER, $39::TEXT, $40::TEXT, $41::TEXT,
        $42::TEXT, $43::TEXT, $44::BOOLEAN, $45::TEXT, $46::INTEGER, $47::BOOLEAN
      )
    `, [
            inc.id || null,
            ...
            inc.condition,
            inc.incidentType,
            parseInt(inc.severity),
            inc.direction,
            inc.location,
            parseInt(inc.countyId),
            inc.countyName,
            inc.city,
            inc.start,
            inc.end,
            inc.lastUpdate,
            inc.road,
            parseInt(inc.routeId),
            inc.isDetour === 'true',
            inc.detour,
            parseInt(inc.lanesClosed),
            parseInt(inc.lanesTotal),
            inc.weightLimit !== 'undefined' ? parseInt(inc.weightLimit) : null,
            inc.widthLimit !== 'undefined' ? parseInt(inc.widthLimit) : null,
            parseInt(inc.heightChangeFeet),
            parseInt(inc.heightChangeInches),
            inc.bridgeInvolved === 'true',
            inc.inWorkZone === 'true',
            inc.fatality === 'true',
            inc.hazardousMaterials === 'true',
            inc.commercialVehicle === 'true',
            inc.overturnedCommercialVehicle === 'true',
            inc.creationDate,
            inc.crossStreetPrefix,
            parseInt(inc.crossStreetNumber),
            inc.crossStreetSuffix,
            inc.crossStreetCommonName,
            parseInt(inc.eventId),
            inc.event,
            inc.constructionDateTime,
            inc.constructionContactNumber,
            inc.link,
            inc.polyline,
            inc.createdFromConcurrent === 'true',
            inc.movableConstruction,
            parseInt(inc.workZoneSpeedLimit),
            inc.icmProject === 'true'
        ]);
...
router.post("/postOldRoadIncident", async (req, res) => {
